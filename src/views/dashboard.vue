  ...
  <div class="dashboard-container">
        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            ...
            <div class="info">
              ...
              <p class="subtitle-title">
                今日新增：{{ aiData.systemOverview.rodayNewDiaries }}
              </p>
            </div>
          </div>
        </el-card>
        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            ...
            <div class="info">
              ...
              <p class="subtitle-title">
                今日新增：{{ aiData.systemOverview.rodayNewSessions }}
              </p>
            </div>
          </div>
        </el-card>
    ...
    <el-row style="margin-top: 20px" :gutter="20">
      ...
      <el-col :span="12">
        <el-card style="width: 100%">
          <template #header>
            <div class="card-header">咨询对话统计</div>
          </template>
          <div class="chart-content">
    ...
    series: [
      {
        name: "平均情绪评分",
        type: "line",
        data: aiData.value.emotionTrend.map((item) => item.avgMoodScore),
        smooth: true,
        lineStyle: {
          width: 3,
          color: "#faebaf",
      ...
      },
      {
        name: "记录数量",
        type: "line",
        data: aiData.value.emotionTrend.map((item) => item.recordCount),
        smooth: true,
        lineStyle: {
          width: 3,
          color: "#eeb5a3",
